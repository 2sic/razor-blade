namespace ToSic.Razor.Blade
{
    ...
    partial class Tag
    {
        ...
        /// So Tag.Img(...) is better than Tag.Other("Img") because it's preconfigured to self-close, encode the src etc.
        /// </summary>
        ...
        public static Markup.TagBase Other(string name, params object[] content)
