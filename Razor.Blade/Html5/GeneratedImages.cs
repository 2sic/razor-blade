...
namespace ToSic.Razor.Html5
{
    ...
    internal Area(object content = null) : base(false, "area", content)
    {
    }
    ...
    internal Area(params object[] content) : base(false, "area", null, content)
    {
    }
    ...
    /// </summary>
    /// <param name="content">content which will be inside the tag</param>
    internal Canvas(object content = null) : base(false, "canvas", content)
    {
    }
    ...
    /// </returns>
    /// <param name="content">one or more objects (strings or tags) which will be inside the tag</param>
    internal Canvas(params object[] content) : base(false, "canvas", null, content)
    {
    }
    ...
    internal Img() : base(false, "img", new TagOptions(close: false))
    {
    }
    ...
    /// </returns>
    /// <param name="content">one or more objects (strings or tags) which will be inside the tag</param>
    internal Img(params object[] content) : base(false, "img", new TagOptions(close: false), content)
    {
    }
    ...
    /// </summary>
    /// <param name="content">content which will be inside the tag</param>
    internal Map(object content = null) : base(false, "map", content)
    {
    }
    ...
    /// </returns>
    /// <param name="content">one or more objects (strings or tags) which will be inside the tag</param>
    internal Map(params object[] content) : base(false, "map", null, content)
    {
    }
    ...
    /// </summary>
    /// <param name="content">content which will be inside the tag</param>
    internal Picture(object content = null) : base(false, "picture", content)
    {
    }
    ...
    /// </returns>
    /// <param name="content">one or more objects (strings or tags) which will be inside the tag</param>
    internal Picture(params object[] content) : base(false, "picture", null, content)
    {
    }
    ...
    /// </summary>
    /// <param name="content">content which will be inside the tag</param>
    internal Svg(object content = null) : base(false, "svg", content)
    {
    }
    ...
    /// </returns>
    /// <param name="content">one or more objects (strings or tags) which will be inside the tag</param>
    internal Svg(params object[] content) : base(false, "svg", null, content)
    {
    }
