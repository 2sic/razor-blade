...
namespace Razor_Blades_Tests.PageProperty
{
    [TestClass]
    public class UpdatePropertyTest
    {
        ...
        {
            var result = Helpers.UpdateProperty(Suffix,
                new PagePropertyChange {ReplacementIdentifier = "[placeholder]", Value = "My Title", ChangeMode = ChangeModes.Replace});
            Assert.AreEqual("My Title", result);
        }
        ...
        {
            var result = Helpers.UpdateProperty(Suffix,
                new PagePropertyChange {ReplacementIdentifier = "[placeholder]", Value = "My Title", ChangeMode = ChangeModes.Prepend});
            Assert.AreEqual("My Title" + Suffix, result);
        }
        ...
        {
            var result = Helpers.UpdateProperty(Suffix,
                new PagePropertyChange {ReplacementIdentifier = "[placeholder]", Value = "My Title", ChangeMode = ChangeModes.Append});
            Assert.AreEqual(Suffix + "My Title", result);
        }
        [TestMethod]
        ...
        {
            var result = Helpers.UpdateProperty(Suffix,
                new PagePropertyChange {ReplacementIdentifier = "[placeholder]", Value = "My Title", ChangeMode = ChangeModes.Auto});
            Assert.AreEqual("My Title", result);
        }
